...
class CirugiaViewSet(viewsets.ModelViewSet):
    ...
    def exportar_todos(self, request):
        ...
        data = queryset.values(
            'tipo_seguro', 'fecha_nacimiento', 'sexo', 'lugar_procedencia',
            'n_hcl', 'fecha_iqx_programada', 'codigo_iqx_programada', 'iqx_programada',
            'fecha_iqx_realizada', 'codigo_iqx_realizada', 'iqx_realizada',
            'se_reprogramo', 'fecha_iqx_reprogramada', 'motivo_reprogramacion',
            'fecha_realizada_iqx_reprogramada', 'codigo_iqx_reprogramada', 'iqx_reprogramada',
            'fecha_creacion'
        )
